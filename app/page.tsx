import HeroImgsSec from "@/components/HeroImgsSec";
      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto px-4 py-32">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-zinc-900 mb-6 text-6xl font-bold font-anta">
            ...
            <div className="flex flex-col items-center gap-4">
              <Link href="/sign-up">
                <Button
                  size="lg"
                  className="text-lg font-medium h-12 px-8 cursor-pointer"
                >
                  Start for free
          ...
          <div className="container mx-auto px-4">
            <div className="grid gap-12 md:grid-cols-3">
              <div className="flex flex-col">
                ...
                <h3 className="mb-3 text-2xl font-semibold text-black font-anta">
